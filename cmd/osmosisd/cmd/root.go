...
import (
	...
	v23 "github.com/osmosis-labs/osmosis/v31/app/upgrades/v23" // should be automated to be updated to current version every upgrade
	...
	osmosis "github.com/osmosis-labs/osmosis/v31/app"
)
...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	tempDir := tempDir()
	tempApp := osmosis.NewOsmosisApp(log.NewNopLogger(), cosmosdb.NewMemDB(), nil, true, map[int64]bool{}, tempDir, 5, sims.EmptyAppOptions{}, osmosis.EmptyWasmOpts, baseapp.SetChainID("oasis-1"))
	defer func() {
