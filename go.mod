...
require (
	...
	// TODO ATOMONE: Crisis module was removed in SDK v0.50+ - need to refactor invariant checks
	// cosmossdk.io/x/crisis v0.1.1
	...
	// TODO ATOMONE: Re-enable async-icq when v10 version is available
...
replace (
	...
	// TODO ATOMONE: Using Osmosis SDK fork instead of AtomOne for now
	// Osmosis SDK fork contains custom bank/staking methods (AddSupplyOffset, InstantUndelegate, etc.)
	// Direct tag link: https://github.com/osmosis-labs/cosmos-sdk/releases/tag/v0.50.14-v30-osmo
	// NOTE: Go modules don't support sub-package replacements, must replace entire module
